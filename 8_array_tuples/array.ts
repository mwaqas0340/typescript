...
// fruitNames1[0] = "strawbbery"      // update array index 0
...
// length method
const fruitName4: string[]= ["apple", "banana", "mango", "orange"];
console.log(fruitName4.length); // length number always start 1 length.
...
arr4.shift();                   
console.log(arr4);                 // remove first element in array
...
// pop method
const arr5: string[]= ["apple","banana","mango"];
arr5.pop();
console.log(arr5);                 // remove last element in array

// splice method
const arr6: string[]= ["apple","banana","mango"];
arr6.splice(0,1,"stawbbery");
        //Add/Remove
console.log(arr6);                 // add/remove element in array

// slice method
// const arr7 = ["apple","banana","mango","stawberry","orange"];
// console.log(arr7);
// const arr7 = arr6.slice(0,3);
//                     // Return
// console.log(arr5);                 // return element in array

let arr8 = ["apple","mango","banana","orange"]
let mySlice = arr.slice(1)
console.log(arr);
console.log(mySlice);

// sort method
const arr9: number []=[34,45,56,34,2]; 
arr9.sort();
console.log(arr9);                 // adjust element in array
...
// reverse method
const student2: string[]=["waqas","kashif","asif","rashid"] 
console.log(student2.reverse());      // reverse element in array
...
// toString method
const students: string[]=["waqas","kashif","asif","rashid"] 
console.log(students.toString());                           // array element convrt to string
