...
// console.log(myTuple); 
// let myTuple:[string,number,boolean,object]=["waqas",5,true,[{name:"Waqas",age:23}]]
// console.log(myTuple[2]);
// const tuple:[object]=[{name:"Muhammad Waqas",rollNo:2226811,city:"Mirpurkhas",batch:1}]
// console.log(tuple);
// let tuple:[string,number]=["waqas",22]
// let myTuple=tuple[1]                 // accesses tuple index
// console.log(myTuple);
